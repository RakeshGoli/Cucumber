...
public class Job_Onboard {
	 ...
	 public void Open_Browser() {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\RakeshReddyGoli\\Downloads\\chromedriver.exe");
	...
	public void form_details() {
		 ...
		 driver.findElement(By.xpath("//input[@id = 'user_login']")).sendKeys("Rakesh_user101");
	 ...
	 public void verify_user() {
		...
		//driver.findElement(By.xpath("//input[@id = 'user-search-input']")).sendKeys("Rakesh_user123");
		 driver.findElement(By.id("user-search-input")).sendKeys("Test@gmail.com");
